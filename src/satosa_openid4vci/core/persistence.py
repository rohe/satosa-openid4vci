...
class Persistence(object):
    ...
    def store_client_info(self, client_info):
        _client_id = client_info["client_id"]
        self.app.storage.store(information_type="client", key=_client_id, value=client_info)

    def get_client_by_id(self, client_id: str) -> dict:
        return self.app.storage.fetch(information_type="client", key=client_id)
    ...
    def get_client_by_bearer_token(self, request_authorization: str):
        ...
        return self.app.storage.fetch(information_type="client", key=_session_info["client_id"])

    def get_client_by_basic_auth(self, http_authorization):
        ...
        return self.app.storage.fetch(information_type="client", key=part[0])
    ...
    def get_registered_client_ids(self):
        return self.app.storage.keys_by_information_type("client")
